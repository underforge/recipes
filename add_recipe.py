...
def add_card_to_index(d: dict) -> None:
    ...
    if servings_str and not any(w in servings_str.lower() for w in ["serving", "cookie", "piece", "portion", "litre", "liter", "ml", "oz", "cup", "lb", "bagel", "pizza", "slice", "bar", "pancake", "muffin"]):
